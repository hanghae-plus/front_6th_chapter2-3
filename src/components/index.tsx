...
// Button 컴포넌트는 shared/ui/button에서 import
export { Button } from "../shared/ui/button/Button"
// Input 컴포넌트는 shared/ui/input에서 import
export { Input } from "../shared/ui/input/Input"
// Select 컴포넌트는 shared/ui/select에서 import
...
export const Table = forwardRef(({ className, ...props }, ref) => (
  <div className="w-full overflow-auto">
    <table ref={ref} className={`table-fixed w-full caption-bottom text-sm  bg-blue-500${className}`} {...props} />
  </div>
))
