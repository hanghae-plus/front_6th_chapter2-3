...
export const SelectContent = ({
  ...
  ref,
  ...props
}: SelectContentProps & { ref?: React.Ref<React.ElementRef<typeof SelectPrimitive.Content>> }) => (
...
export const SelectItem = ({
  ...
  ref,
  ...props
}: SelectItemProps & { ref?: React.Ref<React.ElementRef<typeof SelectPrimitive.Item>> }) => (
